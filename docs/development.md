...
3. If changing conventions (commit format, branch naming, guidance filenames, shared input syntax, etc.), grep across all skills to update consistently:
   ```bash
...
1. **Cross-reference check**: Ensure conventions mentioned in the modified skill match all other skills (commit format, branch naming, pipeline order, canonical guidance file, shared trailing context syntax)
