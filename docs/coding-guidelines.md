...
| Parallel review agents | `(delegate)` step with parallel sub-agents, each focused on a different review dimension (correctness, quality, efficiency); inline fallback executes sequentially | reflect-pr |
